...
mongoose.connect('mongodb+srv://Niketan:pass123@cluster0.3cv8tnw.mongodb.net/?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true });
var db = mongoose.connection;
db.once('open', function () {
    console.log("Hello");
})
// ppid.use(express.urlencoded({extended}))
